...
import { FaFacebook, FaFacebookMessenger, FaLinkedin, FaTelegram, FaTiktok, FaTwitter, FaViber } from "react-icons/fa";
      ...
      <div className="space-y-8 sticky top-28">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
          <div className="flex flex-col items-center text-center mt-6">
            {/* <TitlePillow>Morph Content Creator</TitlePillow> */}
            <img
              loading="lazy"
              src="https://morph-digital-mm.vercel.app/img/logo.png"
              alt="Lin Thandar Phyo - Founder & CEO of Morph Digital"
              className="h-24 w-24 rounded-full object-cover my-4 ring-4 ring-amber-600 bg-[#6F4E37]"
            />
            ...
            <div className="flex gap-3 pt-3">
              <a
                ...
                className="bg-[#6F4E37] text-white hover:bg-amber-700 duration-300 size-10 flex items-center justify-center rounded-full"
              >
