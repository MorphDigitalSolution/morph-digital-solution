...
function Review() {
  return (
    <div className="relative bg-blend-difference bg-left bg-repeat-x bg- [url(https://demo.bosathemes.com/agence/wp-content/uploads/sites/35/2022/11/agency-img3.png)] bg-neutral-800">
      <div className="w-full h-full bg-neutral-80 0/80 pt-20 lg:py-28 text-neutral-100">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row justify-between gap-4 lg:gap-8 p-5 lg:items-center">
            ...
            <BoxReveal boxColor={"#b45309"} duration={0.5}>
              <a
                href=""
                className="bg-white hover:bg-amber-700 hover:text-neutral-100 duration-300 rounded-full py-3 px-6 text-black text-[0.9rem] flex text-center font-semibold uppercase"
              >
                View More
              </a>
            </BoxReveal>
