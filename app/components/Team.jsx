      ...
      <div className="">
        <div className="relative w-full">
          {/* <div className="bg-white shadow-xl relative rounded-3xl overflow-hidden">
              ...
              <div className="p-5 relative text-center">
                <div className="absolute -top-10 left-0 px-5 w-full">
                  <div className="bg-amber-900 h-20 rounded-2xl flex flex-col items-center justify-center text-neutral-300">
                ...
                <div className="flex justify-center pt-9 gap-3 text-3xl">
                  <a
                    href=""
                    className="hover:bg-amber-900 rounded-full border border-neutral-400 hover:text-neutral-300 duration-300 hover:scale-110 text-blue-950 hover:border-amber-900"
                  >
          ...
          <div className="relative bg-neutral-900/60 backdrop-blur-[2px] lg:px-20 text-center py-20 z-10 flex flex-col items-center justify-center">
            ...
            <BoxReveal boxColor={"#b45309"} duration={0.5}>
              <div className="text-4xl lg:text-5xl font-extrabold py-2 text-neutral-300">
                <span className="text-amber-900">Team</span> Members
              </div>
            </BoxReveal>
            <BoxReveal boxColor={"#b45309"} duration={0.5}>
