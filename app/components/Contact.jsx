...
function Contact() {
  return (
    <div className="relative">
      ...
      />
      <div className="relative w-full h-full z-10 bg-white/50 py-10 lg:pt-28 lg:pb-48">
      ...
      <div className="absolute hidden lg:block z-20 top-20 left-0 w-full h-full p-5">
