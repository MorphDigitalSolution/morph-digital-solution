...
const BlogList = ({ blogs, setBlogs, loading, error }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-2xl font-semibold mb-4 text-neutral-900">Blog Posts</h2>
      {sortedBlogs.map((blog) => (
        ...
        >
          {editingBlog && editingBlog._id === blog._id ? (
            ...
            <>
              <h3 className="text-xl text-neutral-800 font-bold mb-2">{blog.title}</h3>
              ...
              <div className="flex pt-3">
                <button
                  ...
                  className="bg-[#e1c769] active:scale-90 duration-300 rounded-lg text-white text-sm px-3 py-1 mr-2 flex items-center gap-1"
                >
                  Edit <FaEdit className="text-base" />
                </button>
                <button
                  className="bg-[#ff7b7b] text-white text-sm px-3 py-1 active:scale-90 duration-300 rounded-lg flex items-center gap-1"
