  ...
  return (
    ...
    >
      <Sidebar open={open} setOpen={setOpen} animate={true}>
        <SidebarBody className="justify-between gap-10 fixed left-0 top-0 z-50 bg-amber-700 text-white">
    ...
    <div className="flex flex-1 md:ps-16">
      <div className="p-2 md:p-10 rounded-tl-2xl flex flex-col gap-2 flex-1 w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-2">
          <div className="w-full rounded-lg bg-slate-200 shadow-lg p-8 h-fit">
            <BlogForm addBlog={addBlog} />
          </div>
          <div className="h-full w-full rounded-lg bg-slate-200 shadow-lg border p-8  ">
            <BlogList
              blogs={blogs}
              setBlogs={setBlogs}
              loading={loading}
