    ...
    <div className="p-8 lg:py-16">
      <div className="max-w-6xl mx-auto p-5">
        <div className="flex gap-2 items-center justify-center flex-col text-center">
          ...
          <BoxReveal boxColor={"#b45309"} duration={0.5}>
            <div className="text-4xl lg:text-5xl font-extrabold lg:py-2 text-[#6F4E37] text- blue-950">
              <span className="text-amber-600">Contact</span> & Join Together
            </div>
          </BoxReveal>
          <BoxReveal boxColor={"#b45309"} duration={0.5}>
            <div className="text-center max-w-2xl mx-auto text-[#6F4E37b1]">
              ...
              Morph Team မှ ချက်ချင်းဆက်သွယ်ပေးပါမယ်ရှင့်။
            </div>
          </BoxReveal>
        </div>
