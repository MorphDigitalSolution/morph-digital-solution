      ...
      <div className="relative bg-blend-difference bg-left bg-repeat-x bg- [url(https://demo.bosathemes.com/agence/wp-content/uploads/sites/35/2022/11/agency-img3.png)] bg- neutral-800">
        <div className="w-full h-full bg- neutral-800/90 flex pb-10">
          <div className="max-w-7xl w-full pt-16 gap-y-8 lg:pb-20 grid sm:grid-cols-2 lg:grid-cols-1 text-center mx-auto text -neutral-100">
            <div className="flex items-center lg:items-center sm:items-end flex-col lg:flex-row w-full px-5 gap-8 sm:gap-5 lg:gap-0 justify-center">
              <div className="p-5">
                <div className="shadow-md hover:shadow-lg rounded-3xl duration-300 border-2 border-[#6f4e37] hover:bg-[#6f4e37]">

                <BoxReveal boxColor={"#b4530900"} duration={0.5}>
                  <div className="relative group rounded-3xl overflow-hidden h-64 w-72 md:w-[350px] lg:w-56 xl:w-64 block">
                  ...
                  <div className="relative group rounded-3xl overflow-hidden h-64 w-72 md:w-[350px] lg:w-56 xl:w-64 block">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 p-2 flex flex-col items-center justify-center">
                      <img
                        ...
                        />
                      <div className="text-xl group-hover:text-white text-[#6f4e37] -mt-5">
                        Influencer Marketing Plan Service
                      </div>
                    </div>
                  </div>
                </BoxReveal>
            ...
            <div className="flex items-center lg:items-center sm:items-start flex-col lg:flex-row w-full px-5 gap-8 sm:gap-5 lg:gap-0 justify-center">
              <div className="p-5">
                <div className="shadow-md hover:shadow-lg rounded-3xl duration-300 border-2 border-[#6f4e37] hover:bg-[#6f4e37]">
                  ...
                  <div className="relative group rounded-3xl overflow-hidden h-64 w-72 md:w-[350px] lg:w-56 xl:w-64 block">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 p-2 flex flex-col items-center justify-center">
                      <img
                        ...
                        />
                      <div className="text-xl group-hover:text-white text-[#6f4e37]">
                        Event Planning & Promotion Service
                      </div>
                    </div>
                  </div>
                </BoxReveal>
                  ...
                  <div className="relative group rounded-3xl overflow-hidden h-64 w-72 md:w-[350px] lg:w-56 xl:w-64 block">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 p-2 flex flex-col items-center justify-center">
                      <img
                        ...
                        />
                      <div className="text-xl group-hover:text-white text-[#6f4e37] -mt-5">
                        Digital Marketing Team Development & Training Service
                      </div>
                    </div>
                  </div>
                </BoxReveal>
                  ...
                  <div className="relative group rounded-3xl overflow-hidden h-64 w-72 md:w-[350px] lg:w-56 xl:w-64 block">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 p-2 flex flex-col items-center justify-center">
                      <img
                        ...
                        />
                      <div className="text-xl group-hover:text-white text-[#6f4e37] -mt-5">
                        Power Point Presentation Creation Service
                      </div>
                    </div>
                  </div>
                </BoxReveal>
        ...
        <div className="lg:absolute z-10 -bottom-24 right-1/2 lg:translate-x-1/2 w-full px-5">
