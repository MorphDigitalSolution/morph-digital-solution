...
const services = [
  ...
  },
  {
    ...
    description: "Web Applications များ (ဥပမာ အီးမေးလ် ကို Website မှတဆင့် အသုံးပြုနိုင်သလို Application မှတဆင့်လဲ အသုံးပြုနိုင်သည့်) ဝဘ်ပလက်ဖောင်းများ ရေးဆွဲပေးပါတယ်ရှင်။",
    imgSrc: "https://morph-digital-mm.vercel.app/img/business.svg",
    justifyContent: "md:justify-end",
  },
];
          ...
          <div className="max-w-6xl w-full pt-16 lg:pb-20 text-center mx-auto text -neutral-100">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 items-center justify-center w-full px-5 gap-10">
              {services.map((service, index) => (
                <div
                  key={index}
                  className={`flex items-center justify-center shadow-md rounded-3xl border-2 border-[#6f4e37] hover:shadow-lg duration-300 hover:bg-[#6f4e37] lg:justify-center ${service.justifyContent}`}
                >
