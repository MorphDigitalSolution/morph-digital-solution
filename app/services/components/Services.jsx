      ...
      <div className="relative bg-blend-difference bg-left bg-repeat-x bg-[ url(https://demo.bosathemes.com/agence/wp-content/uploads/sites/35/2022/11/agency-img3.png)] bg- neutral-800">
        <div className="w-full h-full bg- neutral-800/90 flex pb-20">
          <div className="max-w-7xl w-full flex flex-col text-center items-center justify-center mx-auto text- neutral-100">
            <div className="flex flex-col lg:flex-row w-full px-2 mt-5 gap-8 items-center justify-center">
              <BoxReveal className={'w-full'} boxColor={"#b4530900"} duration={0.5}>
                <div className="p-4 lg:py-8">
                  <a
                    href="/services/web"
                    className="border-[3px] border-[#6F4E37b1] text-[#6F4E37b1] hover:text-white/80 hover:bg-[#6F4E37] duration-300 bg-white shadow-xl relative group rounded-3xl overflow-hidden min-h-96 w-full block"
                  >
                  ...
                  >
                    ...
                    <div className="absolute w-full h-full top-0 left-0 p-5 bg- black/30 flex flex-col items-center text-center justify-center">
                      ...
                      <div className="text-sm pt-5 text-left pb-3 leading-[1.9]">
                        ...
                        တရားဝင်လည်ပတ်နိုင်ရန်အတွက် Morph ​၏ Business Registration Consultant နှင့်အခမဲ့
