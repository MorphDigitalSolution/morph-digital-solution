          ...
          <div className="flex gap-2 items-center justify-center flex-col text-center">
            ...
            <BoxReveal boxColor={"#b45309"} duration={0.5}>
              <div className="text-center max-w-xl mx-auto text-[#6F4E37b1]">
                ကျွန်ုပ်တို့၏ လုပ်ငန်းစဉ်များအရ ပျော်ရွှင်စွာ ထိရောက်စွာ အကောင်အထည်ဖော်ပေးပါတယ်။ အကြံပေးစဉ်းစားမှတ်ယူမှစ၍ လုပ်ဆောင်ချက်အထိ ကျွန်ုပ်တို့သည် သင့်လိုအပ်ချက်များကို ထိရောက်စွာဖြည့်ဆည်းပေးပါတယ်။
              </div>
            </BoxReveal>
          </div>
        </div>
