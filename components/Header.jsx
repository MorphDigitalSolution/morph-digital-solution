...
function Header() {
  ...
  return (
    <>
      <div className={`fixed z-40 top-0 left-0 w-full border-b border-b-gray-100/20 duration-300 ${isScrolled ? "bg-white text-black" : "bg-neutral-900/30 text-white"}`}>
        <div className="max-w-7xl px-5 lg:px-8 mx-auto text-[0.9rem] flex gap-8 py-5 items-center justify-between">
          ...
          >
            <img src="img/logo-sm.png" alt="" className={`h-8 lg:h-10 duration-300 ${isScrolled ? "invert" : "invert-0"}`} />
            <div className="ps-1">MORPH</div>
            <div className="font-bold text-amber-700 text-4xl pb-2">.</div>
          </a>
          <div className="hidden lg:flex gap-8">
            <a href="" className="uppercase font-semibold opacity-80 hover:text-amber-700">
              Home
            </a>
            <a href="" className="uppercase font-semibold opacity-80 hover:text-amber-700">
              About
          ...
          <div className="lg:hidden flex items-center gap-2">
            <a href="" className="py-2 text-xs px-4 rounded-full bg-amber-700 text-white">Let's Talk</a>
